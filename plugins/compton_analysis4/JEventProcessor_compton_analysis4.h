// $Id$
//
//    File: JEventProcessor_compton_analysis4.h
// Created: Mon Nov 23 16:24:15 EST 2020
// Creator: andrsmit (on Linux ifarm1901.jlab.org 3.10.0-1062.4.1.el7.x86_64 x86_64)
//

#ifndef _JEventProcessor_compton_analysis4_
#define _JEventProcessor_compton_analysis4_
...
class JEventProcessor_compton_analysis4:public jana::JEventProcessor{
	
	public:
		JEventProcessor_compton_analysis4();
		~JEventProcessor_compton_analysis4() {};
		const char* className(void){return "JEventProcessor_compton_analysis4";}
	...
	private:
		...
		const double BEAM_RF_time_cut = 6.012;
...
#endif // _JEventProcessor_compton_analysis4_
