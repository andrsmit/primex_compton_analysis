// $Id$
//
//    File: JEventProcessor_compton_analysis_TOF_new.h
...
#ifndef _JEventProcessor_compton_analysis_TOF_new_
#define _JEventProcessor_compton_analysis_TOF_new_
...
class JEventProcessor_compton_analysis_TOF_new:public jana::JEventProcessor{
	
	public:
		JEventProcessor_compton_analysis_TOF_new();
		~JEventProcessor_compton_analysis_TOF_new(){};
		const char* className(void){return "JEventProcessor_compton_analysis_TOF_new";}
...
#endif // _JEventProcessor_compton_analysis_TOF_new_
