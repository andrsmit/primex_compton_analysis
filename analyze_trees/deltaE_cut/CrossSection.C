...
void CrossSection()
{
	...
	sprintf( root_fname,              "%s/analyze_trees/deltaE_cut/rootFiles/Be.root", 
		pathName );
	sprintf( empty_target_root_fname, "%s/analyze_trees/deltaE_cut/rootFiles/Be_empty.root", 
		pathName );
