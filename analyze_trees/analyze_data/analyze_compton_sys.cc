...
int main(int argc, char **argv) {
	...
	sprintf(rootFile_pathName, 
		"/work/halld/home/andrsmit/primex_compton_analysis/analyze_trees/analyze_data/rootFiles", 
	...
	if(genSettings.input_fname!="none") {
		...
		for(int loc_run = genSettings.min_run; loc_run <= genSettings.max_run; loc_run++) {
			...
			sprintf(rootTree_pathName, 
				"/work/halld/home/andrsmit/primex_compton_analysis/data/rootTrees/phase%d/systematics/%06d", 
				loc_phase, loc_run);
			...
			TString output_fname = Form("%s/phase%d/systematics/%06d.root", rootFile_pathName, loc_phase, loc_run);
