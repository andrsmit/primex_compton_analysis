...
void CrossSection_DeltaK(double loc_cut=5.0)
{
	//==============================================================================//
	...
	*/
	...
	hname_tagh = Form("DeltaE/deltaK_tagh_050sigE");
	hname_tagm = Form("DeltaE/deltaK_tagm_050sigE");
	...
	int loc_cut_int = (int)(10.*loc_cut);
	
	char out_fname[256];
	sprintf(out_fname, "DeltaK/%s_%03dnA/tagh_cross_section_%03dsigK.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
	...
	sprintf(out_fname, "DeltaK/%s_%03dnA/tagm_cross_section_%03dsigK.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
