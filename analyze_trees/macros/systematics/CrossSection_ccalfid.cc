...
void CrossSection_ccalfid(int loc_cut_int=5)
{
	//==============================================================================//
	...
	*/
	...
	hname_tagh = Form("ccalfid/deltaK_tagh_ccalfid_%02d", loc_cut_int);
	hname_tagm = Form("ccalfid/deltaK_tagm_ccalfid_%02d", loc_cut_int);
	...
	char out_fname[256];
	sprintf(out_fname, "ccalfid/%s_%03dnA/tagh_cross_section_ccalfid_%02d.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
	...
	sprintf(out_fname, "ccalfid/%s_%03dnA/tagm_cross_section_ccalfid_%02d.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
