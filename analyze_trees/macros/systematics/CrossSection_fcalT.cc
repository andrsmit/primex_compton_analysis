...
void CrossSection_fcalT(double loc_cut=2.0)
{
	//==============================================================================//
	...
	*/
	...
	int loc_cut_int = (int)(10.0 * loc_cut);
	
	hname_tagh = Form("fcalT/deltaK_tagh_%02dfcalT", loc_cut_int);
	hname_tagm = Form("fcalT/deltaK_tagm_%02dfcalT", loc_cut_int);
	...
	char out_fname[256];
	sprintf(out_fname, "fcalT/%s_%03dnA/tagh_cross_section_%02dfcalT.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
	...
	sprintf(out_fname, "fcalT/%s_%03dnA/tagm_cross_section_%02dfcalT.txt", TARGET_STR.Data(), BEAM_CURRENT, loc_cut_int);
