...
void CrossSectionSystematics_deltaE()
{
	...
	sprintf( hname_tagh, "compton_systematics/DeltaE/deltaK_tagh_%02dsigE", sigE_int );
	sprintf( hname_tagm, "compton_systematics/DeltaE/deltaK_tagm_%02dsigE", sigE_int );
	sprintf( hname_tagh_sim, "compton_systematics_sim/DeltaE/deltaK_tagh_%02dsigE", sigE_int );
	sprintf( hname_tagm_sim, "compton_systematics_sim/DeltaE/deltaK_tagm_%02dsigE", sigE_int );
	...
	ofstream outf_tagh( Form("tagh_sigE_%02d.txt", sigE_int) );
	for( int tagh_counter = 1; tagh_counter <= 274; tagh_counter++ ) {
	...
	ofstream outf_tagm( Form("tagm_sigE_%02d.txt", sigE_int) );
	for( int tagm_counter = 1; tagm_counter <= 102; tagm_counter++ ) {
