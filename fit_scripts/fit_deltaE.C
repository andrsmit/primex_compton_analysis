...
void fit_deltaE()
{
	...
	TF1 *fAlpha_guess = new TF1( "fAlpha_guess", "pol3", 5.0, 12.0 );
	fAlpha_guess->SetParameters( 1.17278, 0.271146, -0.0387907, 0.00152967 );
	
	TF1 *fN_guess     = new TF1( "fN_guess",     "pol3", 5.0, 12.0 );
	fN_guess->SetParameters( 1.67368, -0.0416327, 0.0459495, -0.000993214 );
	...
	for( int tagh_counter = 1; tagh_counter <= 274; tagh_counter++ ) 
	{
		...
		*/
		...
		TF1 *f_bkgd_draw = new TF1( Form("f_bkgd_draw_%d",tagh_counter), "pol3", -2.0, 2.0 );
		f_bkgd_draw->SetParameter( 0, f_fit->GetParameter(5) );
		f_bkgd_draw->SetParameter( 1, f_fit->GetParameter(6) );
		f_bkgd_draw->SetParameter( 2, f_fit->GetParameter(7) );
		f_bkgd_draw->SetParameter( 3, f_fit->GetParameter(8) );
		f_bkgd_draw->SetLineColor( kCyan );
		f_bkgd_draw->SetFillColor( kCyan );
		f_bkgd_draw->SetFillStyle( 3004 );
	...
	for( int tagm_counter = 1; tagm_counter <= 102; tagm_counter++ ) 
	{
		...
		*/
		...
		TF1 *f_bkgd_draw = new TF1( Form("f_bkgd_draw_%d",tagm_counter), "pol3", -2.0, 2.0 );
		f_bkgd_draw->SetParameter( 0, f_fit->GetParameter(5) );
		f_bkgd_draw->SetParameter( 1, f_fit->GetParameter(6) );
		f_bkgd_draw->SetParameter( 2, f_fit->GetParameter(7) );
		f_bkgd_draw->SetParameter( 3, f_fit->GetParameter(8) );
